...
TOKEN = '7928239250:AAGOk97LrOu_PicpS1kQdMEPDOREF_cLQ9o'
...
def handle_attack_command(message):
    ...
    try:
        ...
        bot.send_message(chat_id, "*💣 Ready to launch an attack?*\n"  # Ready to launch message
                                   ...
                                   "*Let the chaos begin! @VKP_950🎉*", parse_mode='Markdown')  # Start chaos message
...
def process_attack_command(message):
    try:
        ...
        if target_port in blocked_ports:
            ...
            return
        if duration >= 899:
            bot.send_message(message.chat.id, "*⏳ Maximum duration is 799 seconds.*\n"  # Duration limit message
